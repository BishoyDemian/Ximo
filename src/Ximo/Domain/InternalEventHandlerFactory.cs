...
{
    /// <summary>
    ///     Factory providing logic for creating the <see cref="InternalEventnHandler{TDomainEvent}" /> to handle multiple
    ...
    internal static class InternalEventHandlerFactory
    {
        ...
        /// <returns>A new instance of the <see cref="InternalEventnHandler{TDomainEvent}" />.</returns>
        public static InternalEventnHandler<TDomainEvent> BuildInternalEventHandler<TDomainEvent,
            ...
            where TDomainEventHandler : IDomainEventHandler<TDomainEvent>
        {
            ...
            //2. Check if the event type is contained in the mapping cache. If it is not then initialise it accordingly.
            ...
            var internalEventHandler = new InternalEventnHandler<TDomainEvent>(provider);
