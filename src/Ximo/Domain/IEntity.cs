...
namespace Ximo.Domain
{
    ...
    ///     identify the entity. From a behavioural perspective the only entity behaviour we can generically identify is the
    ///     equality of an entity. By default the implementation of equality should be based on comparing the unique identifier
    ///     of an instance of the entity with another instance of that same entity or an instance of one of its child
    ///     implementations.
    /// </remarks>
    /// <typeparam name="TId">The type of the uniquw identifier.</typeparam>
